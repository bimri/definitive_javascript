...
onmessage = function(message) {
    ...
    for(let row=0, y=0; row < height; row++, y += perPixel) {
    ...
    // it contains will be transferred for a nice permonance boost.
    this.postMessage({tile, ImageData, min, max}, [image.data.buffer]);
};
